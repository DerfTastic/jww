...
<body>
    ...
    <main id="projects" hidden>
        ...
        <a href="/"><article>
        <div id="text">
            <h2>Mandelbrot Visualizer</h2>
            <p>Draws the famous Mandelbrot Set fractal to demonstrate recursion in a Java program.</p>
        </div>
        <img alt="output of the mandelbrot visualizer program running" src="/images/thumbnails/mandelbrot.png">
        <div id=date><p><b>2022</b> - 1st year BSc</p></div>
        </article></a>
